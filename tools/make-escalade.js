...
/* This page has a light background, but the shared header is styled for a dark
   ...
   The header sections carry large negative bottom margins (-90px / -222px) that
   tuck the hero image under the transparent header on other pages; with no hero
   image here, zero them so the content sits below the header instead of behind it. */
