(function () {
  ...
  var T = {
    common: {
      ...
      'Tendinites et épicondylites (épaules, coudes, poignets)': 'Tendinitis and epicondylitis (shoulders, elbows, wrists)',
      'Tensions et douleurs musculaires': 'Muscle tension and soreness',
      'Poignets, doigts et articulations trop sollicités': 'Overworked wrists, fingers and joints',
      'Escalade et bloc — épaules, coudes, poignets et doigts': 'Climbing and bouldering — shoulders, elbows, wrists and fingers',
      'Course à pied — hanches, genoux, chevilles et pieds': 'Running — hips, knees, ankles and feet',
      'Vélo et cyclisme — nuque, bas du dos et genoux': 'Cycling — neck, lower back and knees',
      'Sports de raquette — épaules, coudes et poignets': 'Racquet sports — shoulders, elbows and wrists',
      'Gymnastique et sports acrobatiques — articulations en général': 'Gymnastics and acrobatic sports — joints in general',
      'Avant l’acupuncture, Monique a été gymnaste de compétition et entraîneuse de haut niveau au Canada — quatre médailles d’or en 1977. Cette expérience du sport et de l’entraînement intensif a fait en sorte d’aider à comprendre l’importance de la guérison de chaque blessure.': 'Before acupuncture, Monique was a competitive gymnast and high-level coach in Canada — four gold medals in 1977. That experience of sport and intensive training helped her understand how important it is for every injury to heal properly.',
      'Toujours aussi active dans le sport — triathlon, septembre 2026.': 'Still very much an athlete — triathlon, September 2026.',
      'Les émotions :': 'Emotions:',
      'Le désir :': 'Desire:',
      'La tendance à être :': 'Tendency to be:',
      'Les pièces intérieures :': 'Interior rooms:',
      'Les métiers :': 'Professions:',
      'Les problèmes de santé :': 'Health issues:',
      'Les aides thérapeutiques :': 'Therapeutic aids:',
      'VIVRE, C’EST… étudier le grand mouvement de la Vie. Comprendre le mouvement de la vie qui nous entoure nous permet de comprendre l’influence que ce mouvement a sur notre vie, donc de participer activement à notre mieux-être.  — Monique St-Arnault': 'TO LIVE IS… to study the great movement of Life. Understanding the movement of life around us lets us understand the influence it has on our own, and so take an active part in our well-being.  — Monique St-Arnault',
      '← Tous les articles': '← All articles',
      'Voir tous les articles': 'See all articles',
      'Partager cet article': 'Share this article',
      'Prenons par exemple la nuit et le jour. Ils sont…': 'Take night and day, for example. They are…',
      'L’évolution :': 'Evolution:',
      'Foie, vésicule biliaire': 'Liver, gallbladder',
      'Frustration, irritabilité, colère, stress': 'Frustration, irritability, anger, stress',
      'De se mouvoir, d’être actif, de travailler': 'To move, to be active, to work',
      'De charmer, de vaincre': 'To charm, to conquer',
      'De commencer, de naître': 'To begin, to be born',
      'Salle de séjour, salon': 'Living room, lounge',
      'compétitif, déterminé, organisé, planifié, visionnaire, téméraire, irritable, colérique': 'competitive, determined, organized, methodical, visionary, bold, irritable, quick-tempered',
      'douleurs musculaires, migraine, digestion disharmonieuse, constipation alternée de diarrhée, dépression, allergies, torticolis, toxicomanie': 'muscle pain, migraine, disordered digestion, constipation alternating with diarrhea, depression, allergies, stiff neck, addiction',
      'herbes, aromathérapie, massage musculaire profond, relaxation, visualisation': 'herbs, aromatherapy, deep tissue massage, relaxation, visualization',
      'Diagramme des cinq éléments — Bois, Feu, Terre, Métal et Eau — reliés par le cycle d’engendrement et le cycle de contrôle': 'Diagram of the five elements — Wood, Fire, Earth, Metal and Water — linked by the generating and controlling cycles',
      'Monique St-Arnault à la poutre en gymnastique de compétition, 1977': 'Monique St-Arnault on the beam in competitive gymnastics, 1977',
      'Monique St-Arnault, médaille au cou, au bassin olympique après son triathlon de septembre 2026': 'Monique St-Arnault, medal around her neck, at the Olympic Basin after her September 2026 triathlon',
      '#Tao   #Médecine chinoise   #Qi': '#Tao   #Chinese medicine   #Qi',
      '#Allergies   #Médecine chinoise   #Printemps': '#Allergies   #Chinese medicine   #Spring',
    ...
    '/': {
      ...
      'Ancienne gymnaste et entraîneuse de gymnastique de haut niveau au Canada, Monique connaît intimement le corps de l’athlète : les exigences de l’entraînement, les blessures de surutilisation et l’importance de la récupération. Cette expérience nourrit aujourd’hui sa pratique auprès des sportifs, des grimpeurs aux amateurs actifs, qu’ils soient blessés ou en quête de prévention et de performance.': 'A former high-level gymnast and gymnastics coach in Canada, Monique knows the athlete’s body intimately: the demands of training, overuse injuries and the importance of recovery. This experience now informs her work with active people and athletes — from climbers to recreational sports enthusiasts, whether injured or seeking prevention and performance.',
